...
```bash
git remote add encore encore://habit-tracker-app-ft52
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/habit-tracker-app-ft52/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/habit-tracker-app-ft52/settings/integrations/github)
